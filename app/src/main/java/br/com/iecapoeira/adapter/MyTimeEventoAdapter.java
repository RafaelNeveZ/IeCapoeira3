...
public class MyTimeEventoAdapter extends RecyclerView.Adapter<MyTimeEventoAdapter.MyViewHolder> {
    private List<JSONObject> mList;
    private LayoutInflater mLayoutInflater;
    private RecyclerViewOnClickListenerHack mRecyclerViewOnClickListenerHack;
    private Context context;

    public MyTimeEventoAdapter(Context c, List<JSONObject> list) {
        mList = list;
    ...
    public void setRecyclerViewOnClickListenerHack(MyEventDetailActivity_ evdAcy) {
