...
public class MyMusicaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void showToast(final String msg) {
        ...
        MyMusicaActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MyMusicaActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadFragment() {
        Fragment fragment = MyMusicaFragment_.builder().build();
