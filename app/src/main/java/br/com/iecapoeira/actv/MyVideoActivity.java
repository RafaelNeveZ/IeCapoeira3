...
import br.com.iecapoeira.fragment.MyVideoFragment_;
...
public class MyVideoActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void showToast(final String msg) {
        ...
        MyVideoActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MyVideoActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadFragment() {
        Fragment fragment = MyVideoFragment_.builder().build();
