...
import br.com.iecapoeira.fragment.MyMestreFragment_;
...
public class MyMestreActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void showToast(final String msg) {
        ...
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MyMestreActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void loadFragment() {
        Fragment fragment = MyMestreFragment_.builder().build();
